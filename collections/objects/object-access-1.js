...
/*
const mpName = ...
console.log(mpName); // should log "David Hanson"
*/

/*
const mpSentence = ...
console.log(mpSentence); // should log a string of the form "My name is <name_here>, I am a member of the <party_here>, serving <constituency_name>"
*/
